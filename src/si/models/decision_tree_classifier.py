...
if __name__ == '__main__':
    ...
    ficheiro = 'C:\\Percurso Académico\\Mestrado em Bioinformática - UMinho\\2023-2024\\02 Disciplinas\\1º Semestre\\03 Sistemas Inteligentes para a Bioinformática\\0Base de Dados\\iris.csv'

    data = read_csv(ficheiro, sep=',', features=True, label=True)
